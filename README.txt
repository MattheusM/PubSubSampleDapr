...
DESDE TERMINAL PUBLISHER: dapr run --app-id publisher --app-port 5007 -- dotnet run
DESDE TERMINAL SUBSCRIBER:  dapr run --app-id subscriber --app-port 6007 -- dotnet run
